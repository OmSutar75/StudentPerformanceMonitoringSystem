...
namespace StudentPerformanceManagment.Migrations
{
    ...
    [Migration("20251226081745_SubjectMarkOneTOMany")]
    partial class SubjectMarkOneTOMany
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentPerformanceManagement.Models.Staff", b =>
                {
            ...
            modelBuilder.Entity("StudentPerformanceManagement.Models.Student", b =>
                {
            ...
            modelBuilder.Entity("StudentPerformanceManagment.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("StudentPerformanceManagment.Models.Course", b =>
                {
                    b.Property<int>("CourseId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StudentPerformanceManagment.Models.Mark", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("StudentPerformanceManagment.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StudentPerformanceManagement.Models.Staff", b =>
                {
                    b.HasOne("StudentPerformanceManagment.Models.AppUser", "AppUser")
                        .WithMany()
            ...
            modelBuilder.Entity("StudentPerformanceManagment.Models.Mark", b =>
                {
                    b.HasOne("StudentPerformanceManagement.Models.Student", "Student")
                        .WithMany("Marks")
